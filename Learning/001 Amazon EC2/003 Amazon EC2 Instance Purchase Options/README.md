...
These SW often desingnated to run on specifcic HW
...
- **Host Affinity:** If your license requires that the software remains on specific hardware, you can use host affinity to ensure that your SQL Server instances always run on this Dedicated Host.
...
| **Host Affinity**                | Allows instance placement on specific Dedicated Hosts, enabling host affinity.       | No control over instance placement; AWS handles it.                    |
